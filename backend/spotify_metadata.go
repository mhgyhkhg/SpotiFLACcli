...
func (c *SpotifyMetadataClient) GetTrackMetadata(ctx context.Context, trackID string) (*TrackMetadata, error) {
fmt.Printf("query (%s)...\n", trackID)
    // 1. Clean the ID (remove URL parts if present)
    id := trackID
    if strings.Contains(id, "spotify.com") {
